...
%prep
%setup -q -n khal-0.10.2
cd %{_builddir}/khal-0.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596059419
...
cp %{_builddir}/khal-0.10.2/COPYING %{buildroot}/usr/share/package-licenses/khal/918f3b8f569ca951b053df0aa458c73e219487f5
cp %{_builddir}/khal-0.10.2/doc/source/license.rst %{buildroot}/usr/share/package-licenses/khal/64df61d65c5b96d10ebba081593a79ab7905da29
